...
/**
 * In deze klasse zorgen we ervoor dat Spring Security meer dan 1 attribuut meeneemt in memory na login
 * Spring Security haalt standaard de userID, platform en isMainAccount op van Smartschool, maar we willen ook de groepen van de gebruiker in memory hebben.
 * Daarom maken we een custom OAuth2UserService die na het ophalen van de basisinformatie van nog een extra API call roept voor de groupInfo
...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userReq) throws OAuth2AuthenticationException {
        ...
        // Stap 2. we halen de accessToken en het platform zodat we groupinfo kunnen ophalen

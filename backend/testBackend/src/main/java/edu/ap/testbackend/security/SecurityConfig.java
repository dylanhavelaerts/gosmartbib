...
@EnableMethodSecurity // enabled preauthorisation samen met de authorized URL zorgt dit voor een dubbele muur beveiliging
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(
                                ...
                                "/login/**",
                                "/error"
                        ).hasAnyRole("BIBLIOTHEEKBEHEERDER", "ADMIN")

...
public interface LoanHistoryRepository extends JpaRepository<LoanHistoryEntity, Long> {
    ...
    """)
    List<Object[]> findMostPopularBooks(@Param("schoolId") Long schoolId, Pageable pageable, @Param("className") String className, @Param("grade") String grade);
    ...
    ORDER BY COUNT(lh) DESC
    """)
    List<Object[]> findMostReadGenres(@Param("schoolId") Long schoolId, Pageable pageable, @Param("className") String className, @Param("grade") String grade);
    ...
    """)
    List<Object[]> findMostReadingClasses(@Param("schoolId") Long schoolId);
    ...
    """)
    long countOnTimeReturns(@Param("schoolId") Long schoolId, @Param("className") String className, @Param("grade") String grade);
    ...
    """)
    long countLateReturns(@Param("schoolId") Long schoolId, @Param("className") String className, @Param("grade") String grade);
    ...
    ORDER BY COUNT(lh) DESC
    """)
    List<Object[]> findLoanDurationDistribution(@Param("schoolId") Long schoolId, @Param("className") String className, @Param("grade") String grade);
    ...
    """)
    List<Object[]> findTopReaders(@Param("schoolId") Long schoolId, Pageable pageable, @Param("className") String className, @Param("grade") String grade);
    ...
    """)
    List<Object[]> findLoansPerMonth(@Param("schoolId") Long schoolId, @Param("className") String className, @Param("grade") String grade);
    ...
    List<Object[]> findLeastPopularBooks(@Param("schoolId") Long schoolId, Pageable pageable);

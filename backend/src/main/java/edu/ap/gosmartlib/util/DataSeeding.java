...
public class DataSeeding implements CommandLineRunner {
        ...
        private BookEntity book(
                        ...
                        String previewLink) { // TOEGEVOEGD: previewLink parameter
                ...
                b.setPreviewLink(previewLink); // TOEGEVOEGD: previewLink setten
                ...
                if (bookRepository.count() == 0) {
                        ...
                        List<BookEntity> books = List.of(
                                        book("Harry Potter and the Philosopher's Stone", List.of("J.K. Rowling"),
                                                        ...
                                                        List.of("Vriendschap", "School & prestatiedruk"), "B", 7, 5, null),
                                        book("Harry Potter and the Chamber of Secrets", List.of("J.K. Rowling"),
                                                        "Bloomsbury Publishing", // Aangepast obv JSON
                                                        "WIDESCREEN EDITION - DVD.", // Aangepast obv JSON
                                                        251, List.of("Adventure"), // Aangepast obv JSON
                                                        "https://covers.openlibrary.org/b/isbn/9780747538486-L.jpg",
                                                        "en", 5.0, "9780747538486", 1998, false, false, // Rating 5.0
                                                        List.of("Vriendschap", "School & prestatiedruk"), "B", 6, 3, "http://books.google.be/books?id=_kLanQEACAAJ&dq=isbn:9780747538486&hl=&cd=1&source=gbs_api"), // Toegevoegd
                                        book("Harry Potter and the Prisoner of Azkaban", List.of("J.K. Rowling"),
                                                        ...
                                                        List.of("Familie", "Vriendschap"), "B", 8, 6, null),
                                        book("Harry Potter and the Goblet of Fire", List.of("J.K. Rowling"),
                                                        "Bloomsbury Pub Limited", // Aangepast
                                                        "The summer holidays are dragging on and Harry Potter can't wait for the start of the school year. It is his fourth year at Hogwarts School of Witchcraft and Wizardry and there are spells to be learnt and (unluckily) Potions and Divination lessons to be attended. But Harry can't know that the atmosphere is darkening around him, and his worst enemy is preparing a fate that it seems will be inescapable . . . With characteristic wit, fast-paced humour and marvellous emotional depth, J.K. Rowling has proved herself yet again to be a master story-teller.", // Aangepast
                                                        636, List.of("Juvenile Fiction"), // Aangepast
                                                        "https://covers.openlibrary.org/b/isbn/9780747546245-L.jpg",
                                                        "en", 5.0, "9780747546245", 2000, false, false, // Rating 5.0
                                                        List.of("Vriendschap", "School & prestatiedruk", "Overleven"),
                                                        "C", 9, 4, "http://books.google.be/books?id=5eSxngEACAAJ&dq=isbn:9780747546245&hl=&cd=1&source=gbs_api"), // Toegevoegd
                                        ...
                                        book("Harry Potter and the Half-blood Prince", List.of("J.K. Rowling"),
                                                        "Bloomsbury UK", // Aangepast
                                                        "'In a brief statement on Friday night, Minister for Magic Cornelius Fudge confirmed that He Who Must Not Be Named has returned to this country and is once more active. \"It is with great regret that I must confirm that the wizard styling himself Lord - well, you know who I mean - is alive and among us again,\" said Fudge.' These dramatic words appeared in the final pages of Harry Potter and the Order of the Phoenix. In the midst of this battle of good and evil, Harry Potter and the Half-Blood Prince takes up the story of Harry Potter's sixth year at Hogwarts School of Witchcraft and Wizardry, with Voldemort's power and followers increasing day by day . . .", // Aangepast
                                                        607, List.of("Children's stories"), // Aangepast
                                                        "https://covers.openlibrary.org/b/isbn/9780747581086-L.jpg",
                                                        "en", 4.5, "9780747581086", 2005, false, false,
                                                        List.of("Vriendschap", "Rouw & verlies"), "C", 7, 1, "http://books.google.be/books?id=7lpKSAAACAAJ&dq=isbn:9780747581086&hl=&cd=1&source=gbs_api"), // Toegevoegd
                                        book("HP AND THE DEATHLY HALLOWS (7) ปกแข็ง", List.of("J.K. Rowling"), // Titel aangepast
                                                        "Bloomsbury UK", // Aangepast
                                                        "The seventh and final volume of the spellbinding Harry Potter series.", // Aangepast
                                                        607, List.of("England"), // Aangepast
                                                        ...
                                                        5, "http://books.google.be/books?id=mNgJMQAACAAJ&dq=isbn:9780747591054&hl=&cd=1&source=gbs_api"), // Toegevoegd
                                        ...
                                        book("The Fellowship of the Ring", List.of("J.R.R. Tolkien"),
                                                        ...
                                                        List.of("Vriendschap", "Avontuur & ontdekking"), "C", 8, 3, null),
                                        book("The Two Towers", List.of("J.R.R. Tolkien"), "George Allen & Unwin",
                                                        ...
                                                        List.of("Vriendschap", "Overleven"), "C", 7, 4, null),
                                        ...
                                        book("The Chronicles of Narnia: The Lion, the Witch and the Wardrobe",
                                                        ...
                                                        List.of("Familie", "Avontuur & ontdekking"), "A", 5, 4, null),
                                        book("A Game of Thrones", List.of("George R.R. Martin"), "Bantam Books",
                                                        ...
                                                        List.of("Macht & onrecht", "Familie"), "D", 9, 7, null),
                                        ...
                                        book("Ender's Game", List.of("Orson Scott Card"), "Tor Books",
                                                        ...
                                                        List.of("School & prestatiedruk", "Overleven"), "B", 8, 2, null),
                                        ...
                                        book("Catching Fire", List.of("Suzanne Collins"), "Scholastic",
                                                        ...
                                                        List.of("Macht & onrecht", "Overleven"), "B", 6, 2, null),
                                        ...
                                        book("The Maze Runner", List.of("James Dashner"), "Delacorte Press",
                                                        ...
                                                        List.of("Overleven", "Identiteit & zelfbeeld"), "B", 7, 5, null),
                                        ...
                                        book("Pride and Prejudice", List.of("Jane Austen"), "T. Egerton",
                                                        ...
                                                        List.of("Liefde & relaties", "Familie"), "C", 8, 6, null),
                                        ...
                                        book("Wuthering Heights", List.of("Emily Brontë"), "Thomas Cautley Newby",
                                                        ...
                                                        List.of("Liefde & relaties", "Rouw & verlies"), "C", 4, 2, null),
                                        ...
                                        book("Lord of the Flies", List.of("William Golding"), "Faber and Faber",
                                                        ...
                                                        List.of("Overleven", "Macht & onrecht"), "C", 9, 4, null),
                                        ...
                                        book("Animal Farm", List.of("George Orwell"), "Secker & Warburg",
                                                        ...
                                                        List.of("Macht & onrecht"), "B", 7, 6, null),
                                        ...
                                        book("A Tale of Two Cities", List.of("Charles Dickens"), "Chapman & Hall",
                                                        ...
                                                        List.of("Liefde & relaties", "Oorlog & conflict"), "C", 4, 3, null),
                                        ...
                                        book("Macbeth", List.of("William Shakespeare"), "Various",
                                                        ...
                                                        List.of("Macht & onrecht", "Mentale gezondheid"), "D", 8, 1, null),
                                        ...
                                        book("Life of Pi", List.of("Yann Martel"), "Knopf Canada",
                                                        ...
                                                        List.of("Overleven", "Avontuur & ontdekking"), "C", 4, 2, null),
                                        ...
                                        book("Holes", List.of("Louis Sachar"), "Farrar, Straus and Giroux",
                                                        ...
                                                        List.of("Vriendschap", "Macht & onrecht"), "A", 5, 1, null),
                                        ...
                                        book("Charlie and the Chocolate Factory", List.of("Roald Dahl"),
                                                        ...
                                                        List.of("Familie", "Armoede & ongelijkheid"), "A", 7, 5, null),
                                        book("Charlotte's Web", List.of("E.B. White"), "Harper & Brothers",
                                                        ...
                                                        List.of("Vriendschap", "Rouw & verlies"), "A", 4, 1, null),
                                        ...
                                        book("The Selfish Gene", List.of("Richard Dawkins"), "Oxford University Press",
                                                        ...
                                                        List.of("Avontuur & ontdekking"), "D", 5, 2, null),
                                        ...
                                        book("The Origin of Species", List.of("Charles Darwin"), "John Murray",
                                                        ...
                                                        List.of("Avontuur & ontdekking"), "D", 6, 1, null),
                                        book("Silent Spring", List.of("Rachel Carson"), "Houghton Mifflin",
                                                        ...
                                                        List.of("Macht & onrecht"), "C", 4, 2, null),
                                        ...
                                        book("The Art of War", List.of("Sun Tzu"), "Various",
                                                        ...
                                                        List.of("Macht & onrecht", "Oorlog & conflict"), "C", 6, 2, null),
                                        book("Thinking, Fast and Slow", List.of("Daniel Kahneman"),
                                                        ...
                                                        List.of("Identiteit & zelfbeeld"), "D", 5, 4, null),
                                        ...
                                        book("The Republic", List.of("Plato"), "Various",
                                                        ...
                                                        List.of("Macht & onrecht"), "D", 9, 6, null),
                                        ...
                                        book("Becoming", List.of("Michelle Obama"), "Crown",
                                                        ...
                                                        List.of("Identiteit & zelfbeeld", "Familie"), "C", 4, 1, null),
                                        ...
                                        book("The Clean Coder", List.of("Robert C. Martin"), "Prentice Hall",
                                                        ...
                                                        List.of("School & prestatiedruk"), "B", 5, 2, null),
                                        ...
                                        book("Cracking the Coding Interview", List.of("Gayle Laakmann McDowell"),
                                                        ...
                                                        List.of("School & prestatiedruk"), "C", 7, 3, null),
                                        book("The Girl with the Dragon Tattoo", List.of("Stieg Larsson"),
                                                        ...
                                                        List.of("Macht & onrecht", "Overleven"), "C", 9, 5, null),
                                        book("Gone Girl", List.of("Gillian Flynn"), "Crown Publishing Group",
                                                        ...
                                                        List.of("Liefde & relaties", "Macht & onrecht"), "C", 6, 4, null),
                                        ...
                                        book("Murder on the Orient Express", List.of("Agatha Christie"),
                                                        ...
                                                        List.of("Macht & onrecht"), "B", 8, 5, null),
                                        book("The Da Vinci Code", List.of("Dan Brown"), "Doubleday",
                                                        ...
                                                        List.of("Avontuur & ontdekking"), "B", 7, 1, null),
                                        ...
                                        book("Freakonomics", List.of("Steven D. Levitt", "Stephen J. Dubner"),
                                                        ...
                                                        List.of("Armoede & ongelijkheid"), "B", 4, 1, null),
                                        book("The Lean Startup", List.of("Eric Ries"), "Crown Business",
                                                        ...
                                                        List.of("Identiteit & zelfbeeld"), "B", 6, 5, null),
                                        book("Rich Dad Poor Dad", List.of("Robert T. Kiyosaki"), "Warner Books",
                                                        ...
                                                        List.of("Familie", "Armoede & ongelijkheid"), "B", 8, 4, null),
                                        book("How to Win Friends and Influence People", List.of("Dale Carnegie"),
                                                        ...
                                                        List.of("Vriendschap", "Liefde & relaties"), "B", 7, 2, null),
                                        ...
                                        book("The 7 Habits of Highly Effective People", List.of("Stephen R. Covey"),
                                                        ...
                                                        List.of("Identiteit & zelfbeeld"), "B", 5, 1, null),
                                        ...
                                        book("Steal Like an Artist", List.of("Austin Kleon"), "Workman Publishing",
                                                        ...
                                                        List.of("Identiteit & zelfbeeld"), "A", 6, 3, null),
                                        book("The Elements of Style", List.of("William Strunk Jr.", "E.B. White"),
                                                        ...
                                                        List.of("School & prestatiedruk"), "B", 8, 6, null),
                                        ...
                                        book("Treasure Island", List.of("Robert Louis Stevenson"),
                                                        ...
                                                        List.of("Avontuur & ontdekking", "Overleven"), "B", 9, 4, null),
                                        book("Robinson Crusoe", List.of("Daniel Defoe"), "W. Taylor",
                                                        ...
                                                        List.of("Overleven", "Avontuur & ontdekking"), "C", 6, 1, null),
                                        ...
                                        book("Around the World in Eighty Days", List.of("Jules Verne"),
                                                        ...
                                                        List.of("Avontuur & ontdekking"), "B", 8, 5, null),
                                        ...
                                        book("One Hundred Years of Solitude", List.of("Gabriel García Márquez"),
                                                        ...
                                                        List.of("Familie", "Rouw & verlies"), "D", 5, 1, null),
                                        ...
                                        book("Don Quixote", List.of("Miguel de Cervantes"), "Francisco de Robles",
                                                        ...
                                                        List.of("Vriendschap", "Avontuur & ontdekking"), "D", 8, 7, null),
                                        ...
                                        book("The Count of Monte Cristo", List.of("Alexandre Dumas"), "Chapman & Hall",
                                                        ...
                                                        List.of("Macht & onrecht", "Overleven"), "D", 7, 2, null),
                                        ...
                                        book("The Golden Compass", List.of("Philip Pullman"), "Scholastic",
                                                        ...
                                                        List.of("Avontuur & ontdekking", "Vriendschap"), "B", 8, 3, null),
                                        book("Coraline", List.of("Neil Gaiman"), "Bloomsbury",
                                                        ...
                                                        List.of("Familie", "Overleven"), "A", 7, 5, null),
                                        ...
                                        book("The Giver of Stars", List.of("Jojo Moyes"), "Penguin Books",
                                                        ...
                                                        List.of("Vriendschap", "Avontuur & ontdekking"), "B", 7, 3, null),
                                        ...
                                        book("Why We Sleep", List.of("Matthew Walker"), "Scribner",
                                                        ...
                                                        List.of("Mentale gezondheid"), "C", 7, 4, null),
                                        book("The Body: A Guide for Occupants", List.of("Bill Bryson"), "Doubleday",
                                                        ...
                                                        List.of("Avontuur & ontdekking"), "C", 5, 2, null),
                                        book("The Notebook", List.of("Nicholas Sparks"), "Warner Books",
                                                        ...
                                                        List.of("Liefde & relaties", "Rouw & verlies"), "A", 9, 8, null),
                                        ...
                                        book("The Hidden Life of Trees", List.of("Peter Wohlleben"), "Greystone Books",
                                                        ...
                                                        List.of("Avontuur & ontdekking"), "B", 4, 3, null),
                                        ...
                                        book("A Wrinkle in Time", List.of("Madeleine L'Engle"),
                                                        ...
                                                        List.of("Familie", "Avontuur & ontdekking"), "A", 4, 1, null),
                                        ...
                                        book("Good Omens", List.of("Terry Pratchett", "Neil Gaiman"), "Gollancz",
                                                        ...
                                                        List.of("Vriendschap", "Humor"), "B", 4, 2, null),
                                        book("Catch-22", List.of("Joseph Heller"), "Simon & Schuster",
                                                        ...
                                                        List.of("Macht & onrecht", "Oorlog & conflict"), "C", 9, 6, null),
                                        ...
                                        book("Blink: The Power of Thinking Without Thinking",
                                                        ...
                                                        List.of("Identiteit & zelfbeeld"), "B", 8, 4, null),
                                        ...
                                        book("The Last Wish", List.of("Andrzej Sapkowski"), "SuperNOWA",
                                                        ...
                                                        List.of("Overleven", "Avontuur & ontdekking"), "B", 9, 5, null),
                                        ...
                                        book("The Design of Everyday Things", List.of("Don Norman"), "Basic Books",
                                                        ...
                                                        List.of("Toekomst & technologie"), "C", 5, 2, null),
                                        book("Don't Make Me Think", List.of("Steve Krug"), "New Riders",
                                                        ...
                                                        List.of("Toekomst & technologie"), "B", 7, 6, null),
                                        book("The Secret Garden", List.of("Frances Hodgson Burnett"),
                                                        ...
                                                        List.of("Vriendschap", "Identiteit & zelfbeeld"), "A", 8, 3, null),
                                        book("Anne of Green Gables", List.of("L.M. Montgomery"),
                                                        ...
                                                        List.of("Familie", "Identiteit & zelfbeeld"), "A", 4, 2, null),
                                        ...
                                        book("Alice's Adventures in Wonderland", List.of("Lewis Carroll"), "Macmillan",
                                                        ...
                                                        List.of("Avontuur & ontdekking"), "A", 9, 4, null),
                                        book("Moby-Dick", List.of("Herman Melville"), "Harper & Brothers",
                                                        ...
                                                        List.of("Overleven", "Avontuur & ontdekking"), "D", 5, 1, null),
                                        ...
                                        book("The Wind in the Willows", List.of("Kenneth Grahame"), "Methuen",
                                                        ...
                                                        List.of("Vriendschap", "Avontuur & ontdekking"), "A", 6, 4, null));
